...
public class HertzServiceLocator extends org.apache.axis.client.Service implements com.idc.jv.HertzService {
    ...
    private java.lang.String HertzServiceSoap_address = "http://hertzservicedemo.rousesales.com/hertzservice.asmx";
    ...
    public com.idc.jv.HertzServiceSoap_PortType getHertzServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.idc.jv.HertzServiceSoap_PortType getHertzServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.idc.jv.HertzServiceSoap_BindingStub _stub = new com.idc.jv.HertzServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.idc.jv.HertzServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.idc.jv.HertzServiceSoap_BindingStub _stub = new com.idc.jv.HertzServiceSoap_BindingStub(new java.net.URL(HertzServiceSoap_address), this);
                _stub.setPortName(getHertzServiceSoapWSDDServiceName());
                return _stub;
            }
        }
